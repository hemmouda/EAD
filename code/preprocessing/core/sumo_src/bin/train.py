...
def get_args():
    parser = argparse.ArgumentParser(
        description="Train UTime on EEG data and gold standard spindles"
    )
    parser.add_argument(
        "-e",
        "--experiment",
    ...
    parser.add_argument(
        ...
        type=str,
        default=None,
        help="Name of configuration group to use for this run",
    )
...
if __name__ == "__main__":
    ...
    config = Config(args.experiment, config_group=args.config_group)
